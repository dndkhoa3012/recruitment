                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                        <button
                            ...
                            className={`flex h-11 shrink-0 items-center justify-center gap-x-2 rounded-xl px-5 text-sm font-semibold shadow-sm transition-all whitespace-nowrap ${selectedCategory === 'all'
                                ? 'bg-[#13a4ec] text-white'
                                : 'bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-[#111618] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                                }`}
                        >
                            Tất cả
                        </button>
                        {categories
                            ...
                            .map(cat => (
                                <button
                                    ...
                                    className={`flex h-11 shrink-0 items-center justify-center gap-x-2 rounded-xl px-5 text-sm font-semibold shadow-sm transition-all whitespace-nowrap ${selectedCategory === cat.id
                                        ? 'bg-[#13a4ec] text-white'
                                        : 'bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-[#111618] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                                        }`}
                                >
