...
import { Form, Input, Button, Select, message, InputNumber, Switch, Space, Spin } from "antd";
import { ArrowLeftOutlined, SaveOutlined } from "@ant-design/icons";
import { getBanners, updateBanner } from "../banner.service";
...
const EditBannerPage = () => {
    ...
    const fetchBanner = async () => {
        try {
            ...
            const banner = data.find((b: any) => b.id === bannerId);
            ...
            if (banner.imageUrls && Array.isArray(banner.imageUrls)) {
